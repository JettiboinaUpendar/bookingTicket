...
public class bookingTest {
	...
	public void browser_is_open() throws InterruptedException {
		...
		System.setProperty("webdriver.gecko.driver","D:\\Download\\geckodriver-v0.33.0-win-aarch64");
	...
	/*
	@Test(priority=10)
	@Then("click on depature")
	public void click_on_depature() throws InterruptedException{
	...
	*/
	...
	public void enter_first_name() throws InterruptedException {
		driver.findElement(By.xpath("//input[@placeholder=\"First & Middle Name\"]")).sendKeys("ashok");
		Thread.sleep(3000);
	}
	@Test(priority=23)
	...
	public void enter_phone_number() throws InterruptedException {
		driver.findElement(By.xpath("//input[@placeholder='Mobile No']")).sendKeys("9848022338");
		Thread.sleep(3000);
	}
	...
	public void enter_email() throws InterruptedException {
		driver.findElement(By.xpath("//input[@placeholder='Email']")).sendKeys("ashokkiran98480@gmail.com");
		Thread.sleep(3000);
